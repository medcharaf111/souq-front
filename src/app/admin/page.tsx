  ...
  return (
    <main style={{ maxWidth: 760, margin: "0 auto" }}>
      ...
      <p style={{ fontSize: 13, color: "#666" }}>
        Internal page. Lists every merchant who has installed the partner app.
        Each merchant gets their own frontend deployment with{" "}
        <code>NEXT_PUBLIC_STORE_ID</code> set to the store_id you see here.
      </p>
      <p>
        <a
          href={api.installUrl()}
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ textAlign: "left", borderBottom: "1px solid #ddd" }}>
              ...
              <th style={{ padding: "8px 4px" }}>store_id</th>
          ...
          <tbody>
            {stores.map((s) => (
              <tr key={s.store_id} style={{ borderBottom: "1px solid #f0f0f0" }}>
                ...
                <td style={{ padding: "10px 4px" }}>{s.product_count}</td>
